    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Create, update, or remove initiatives.</p>
        </div>
        {!showForm && (
          <button
            onClick={() => {
        ...
        >
                  ...
                  <td className="px-8 py-5">
                    <div className="flex items-center gap-4">
                      <div className="h-10 w-16 rounded-lg bg-slate-900 overflow-hidden relative border border-slate-700 shadow-inner">
                         <img src={project.image} alt="" className="object-cover w-full h-full group-hover:scale-110 transition-transform duration-500" />
                      </div>
          ...
          {projects.length === 0 && !loading && (
            <div className="p-24 text-center">
              ...
              <p className="text-slate-500 text-sm">Your impact history is currently empty.</p>
            </div>
          )}
        </motion.div>
      )}
