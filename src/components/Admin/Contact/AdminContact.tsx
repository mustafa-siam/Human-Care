...
import { Trash2, Mail, Phone, User, MessageSquare, Calendar, Loader2, Inbox, X, Eye } from "lucide-react";
  ...
  const fetchContacts = async () => {
    ...
    try {
      ...
      if (res.success && res.data) {
        const normalizedContacts: Contact[] = res.data.map((c: any) => ({
          ...c,
          phone: c.phone ?? "",
        }));
          ...
          <tbody className="divide-y divide-slate-800">
            {contacts.map((c) => (
              ...
              >
                ...
                <td className="px-6 py-5">
                  <div className="text-emerald-400 text-xs font-bold uppercase mb-1">{c.subject}</div>
        ...
        {selectedMessage && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-2xl bg-[#1e293b] border border-slate-700 rounded-3xl shadow-2xl overflow-hidden"
            >
              {/* Modal Header */}
