  ...
  return (
    <section id="projects" className="py-24 bg-gray-50 relative">
      <div className="container mx-auto px-6">
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <motion.button
                  className="mt-6 w-full flex items-center justify-center gap-2 text-[#10B981] hover:text-[#059669] group-hover:gap-3 transition-all duration-300"
                  whileHover={{ x: 5 }}
                >
                  View Details
        ...
        >
          <motion.button
            className="bg-[#0F172A] hover:bg-[#1E293B] text-white px-8 py-4 rounded-full font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
